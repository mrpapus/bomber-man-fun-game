...
function powerupcol(row, col, charx, chary, change, type) {
	...
	if (rectCollide(char, energysquare)) {
		if (type === 1) {
			if (energysquare.t === bombpower) {
				bombpower++;
				cells[row][col] = "noth";
				collision(row, col);
			}
			if (energysquare.t === speed1) {
				speed1 += 0.5;
				cells[row][col] = "noth";
				collision(row, col);
			}
			if (energysquare.t === firepower) {
				firepower++;
				cells[row][col] = "noth";
				collision(row, col);
			}
		...
		if (type === 2) {
			if (energysquare.t === bombpower2) {
				bombpower2++;
				cells[row][col] = "noth";
				collision(row, col);
			}
			if (energysquare.t === speed2) {
				speed2 += 0.5;
				cells[row][col] = "noth";
				collision(row, col);
			}
			if (energysquare.t === firepower2) {
				firepower2++;
				cells[row][col] = "noth";
				collision(row, col);
			}
